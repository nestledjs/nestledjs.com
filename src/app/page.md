...
{% quick-link title="Automatic Updates" icon="lightbulb" href="/docs/updates" description="Pull template security patches, dependency bumps, and new features into your project with one command — verified, on a branch, no lock-in." /%}
